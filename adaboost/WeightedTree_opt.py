...
"""
This is the exact same procedure as Tree_opt, however the small difference is that this is a more general tree that takes a probablility distribution
asssociated with a dataset. We know we could have only used this algorithm but since we were working in a rush and wanted to keep minimal changes we decided 
to keep both Tree_opt and WeightedTree_opt.
"""
